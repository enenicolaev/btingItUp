...
/* harmony import */ var _modules_differencies__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/differencies */ "./src/js/modules/differencies.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  new _modules_differencies__WEBPACK_IMPORTED_MODULE_3__["default"](".officerold", ".officernew", ".officer__card-item").init();
  new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]("form").init();
  new _modules_tabs__WEBPACK_IMPORTED_MODULE_5__["default"](".plus__content").init();
  new _modules_download__WEBPACK_IMPORTED_MODULE_6__["default"](".download").init();
});

/***/ }),

/***/ "./src/js/modules/differencies.js":
/*!****************************************!*\
  !*** ./src/js/modules/differencies.js ***!
  \****************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Differencies; });
...
/*#__PURE__*/
function () {
  function Differencies(officerOld, officerNew, items) {
    _classCallCheck(this, Differencies);
  ...
  _createClass(Differencies, [{
    key: "hideContent",
    value: function hideContent(items) {
    ...
    key: "addTriggers",
    value: function addTriggers(container, items, counter) {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function play() {
      ...
      this.btns.forEach(function (btn, i) {
        ...
        btn.addEventListener("click", function () {
          if (btn.closest(".showup__video") || btn.closest(".module__video-item").getAttribute("data-disabled") !== "true") {
            _this.activeBtn = btn;
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    key: "addHansonSlider",
    value: function addHansonSlider() {
      var _this = this;
      ...
      try {
        ...
        if (this.slideIndex == 3) {
          setTimeout(function () {
            _this.timerBlock.classList.add("animated");

            _this.timerBlock.classList.add("slideInUp");

            _this.timerBlock.style.opacity = "1";
          }, 3000);
        } else {
    ...
    key: "addAdditionalTriggers",
    value: function addAdditionalTriggers() {
      var _this2 = this;

      if (document.querySelector(".prev > .prevmodule")) {
        document.querySelectorAll(".module__info-controls > .prev").forEach(function (item) {
      ...
      if (document.querySelector(".next > .nextmodule")) {
        document.querySelectorAll(".module__info-controls > .next").forEach(function (item) {
          item.addEventListener("click", function (e) {
            e.stopPropagation();
            e.preventDefault();
